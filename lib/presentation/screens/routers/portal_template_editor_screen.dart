...
class PortalTemplateEditorScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<PortalTemplateEditorScreen> createState() =>
      _PortalTemplateEditorScreenState();
}

class _PortalTemplateEditorScreenState
    extends ConsumerState<PortalTemplateEditorScreen>
    with SingleTickerProviderStateMixin {
  final _titleCtrl = TextEditingController();
  final _primaryCtrl = TextEditingController();
  final _supportCtrl = TextEditingController(
    text: 'Need help? Contact the attendant.',
  );
    ...
    try {
      ...
      try {
        ...
        if (result.bytes.length > 150 * 1024) {
          setState(() {
            _status =
                'Image still too large after compression (${(result.bytes.length / 1024).toStringAsFixed(1)}KB). '
  ...
  void _performPreviewUpdate() {
    ...
    try {
      ...
      final branding = PortalBranding(
        ...
        primaryHex: _primaryCtrl.text.trim().isEmpty
            ? template.defaultPrimaryHex
            : _primaryCtrl.text.trim(),
        supportText: _supportCtrl.text.trim().isEmpty
            ? 'Need help? Contact the attendant.'
            : _supportCtrl.text.trim(),
        themeId: _themeId,
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      setState(() {
        ...
        _primaryCtrl.text =
            (m['primaryHex'] as String?)?.trim().isNotEmpty == true
            ? (m['primaryHex'] as String).trim()
            : template.defaultPrimaryHex;
        _supportCtrl.text =
            (m['supportText'] as String?) ??
            'Need help? Contact the attendant.';
        ...
        _logoBytes = (logoB64 == null || logoB64.isEmpty)
            ? null
            : base64Decode(logoB64);
        _bgBytes = (bgB64 == null || bgB64.isEmpty)
            ? null
            : base64Decode(bgB64);
        ...
        if (_logoBytes != null && _logoFilename == null) {
          ...
          final format =
              detectedFormat ??
              (_logoMime?.contains('jpeg') == true
                  ? 'jpg'
                  : _logoMime?.contains('gif') == true
                  ? 'gif'
                  : _logoMime?.contains('webp') == true
                  ? 'webp'
                  : 'png');
        ...
        if (_bgBytes != null && _bgFilename == null) {
          ...
          final format =
              detectedFormat ??
              (_bgMime?.contains('jpeg') == true
                  ? 'jpg'
                  : _bgMime?.contains('webp') == true
                  ? 'webp'
                  : 'jpg');
    ...
    try {
      ...
      if (mounted) {
        ...
        NotificationToast.show(
          ...
          NotificationData(
            title: 'Saved',
            message: 'Portal configuration saved locally',
    ...
    try {
      ...
      if (mounted) {
        ...
        NotificationToast.show(
          ...
          NotificationData(
            title: 'Success',
            message: 'Portal applied to router successfully',
            type: NotificationType.success,
          ),
        );
      }
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        IconButton(
                          onPressed: () =>
                              context.go(PortalTemplateGridScreen.routePath),
                  ...
                  children: [
                    ...
                    if (_status != null) ...[
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color:
                              _status!.startsWith('Apply failed') ||
                          ...
                          children: [
                            ...
                            TextField(
                              ...
                              decoration: InputDecoration(
                                ...
                                helperText:
                                    'Text shown to users on the portal. You can use multiple lines.',
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        Text(
                          '${(_cardOpacity * 100).toStringAsFixed(0)}%',
                          style: Theme.of(
                            context,
                    ...
                    Row(
                      children: [
                        ...
                        Text(
                          '${_borderWidth.toStringAsFixed(0)}px',
                          style: Theme.of(
                            context,
                          ).textTheme.bodyMedium?.copyWith(fontSize: 12),
                        ),
                    ...
                    Row(
                      children: [
                        ...
                        Text(
                          '${_borderRadius.toStringAsFixed(0)}px',
                          style: Theme.of(
                            context,
                          ).textTheme.bodyMedium?.copyWith(fontSize: 12),
                        ),
